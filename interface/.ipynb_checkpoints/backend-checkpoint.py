...
def put_in_table(dictionary):
    return '<table class="table table-hover table-dark"><thead><tr><th scope="col">#</th><th scope="col">Matched Document</th><th scope="col">Link to the Document</th></tr></thead>' + create_row(dictionary) + '</table>'
